                    ...
                    <div className={`col grid-item ${item.catcls}`} key={i}>
                        <div className="courses__item shine__animate-item">
                            ...
                            <div className="courses__item-content">
                                <ul className="courses__item-meta list-wrap w-100">
                                    <li><i className="flaticon-file" /> Start on : {item.starton}</li>
                            ...
                            {(item?.description ?? "").trim().split(/\s+/).length > 10
                                ? (
                                <> 
                                    {(item?.description ?? "").trim().split(/\s+/).slice(0, 10).join(" ")}...{" "}
                                    <Link href={`/course/${item.id}`} className="text-blue-600 underline">
                                    Read more
                                    </Link>
                                </>
                                )
