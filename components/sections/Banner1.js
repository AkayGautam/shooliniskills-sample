                    ...
                    <div className="row">
                        <div className="col-lg-6">
                            <div className="banner__content">
                                ...
                                <span className="sub-title" data-aos="fade-right" data-aos-delay={200}>100% Satisfaction
                                    Guarantee</span>
                                <h3 className="title tg-svg" data-aos="fade-right" data-aos-delay={400}>Make Acquiring  <span className="position-relative"><span className="svg-icon" id="svg-2" data-svg-icon="assets/img/icons/title_shape.svg" />Skills</span>Online Worthwhile</h3>
                                <p data-aos="fade-right" data-aos-delay={600}>Career progression in 12–16 weeks with capstone and industry feedback.
                        ...
                        <div className="col-lg-6">
                            <div className="banner__images">
                                <img src="/assets/img/banner/bg-image.png" alt="img" className="main-img" />
